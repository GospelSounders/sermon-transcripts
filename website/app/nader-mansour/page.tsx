...
export default function NaderMansourPage() {
  ...
  useEffect(() => {
    // Load ministry data
    fetch('/sermon-transcripts/data/nader-mansour.json')
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 max-w-md mx-auto">
            <h2 className="text-xl font-bold text-yellow-900 mb-4">Coming Soon</h2>
            <p className="text-yellow-700 mb-4">
              Nader Mansour sermon transcripts are being processed and will be available soon.
            </p>
            <div className="space-y-3">
              <a 
                href="https://www.youtube.com/@NaderMansour" 
                target="_blank"
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4 text-sm">
                  ...
                  {ministryData.stats.languages.map((language) => (
                    <span key={language} className="bg-green-100 text-green-800 px-3 py-1 rounded-full font-medium">
                      {language}
                    </span>
                  ))}
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600 mb-2">{ministryData.stats.total_sermons}</div>
                <div className="text-gray-600 text-sm">Total Sermons</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600 mb-2">{ministryData.stats.languages.length}</div>
                <div className="text-gray-600 text-sm">Languages</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600 mb-2">{ministryData.stats.topics.length}</div>
                ...
                <div key={sermon.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button 
                        className="flex items-center gap-2 bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50 text-sm"
                        disabled
                      >
